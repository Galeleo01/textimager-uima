...
public class PolyglotPOS  extends PolyglotBase {
    ...
    private Map<Integer, Map<Integer, Token>> processPOS(JCas aJCas, int beginOffset) throws JepException {
        Map<Integer, Map<Integer, Token>> tokensMap = new HashMap<>();
        ArrayList<HashMap<String, Object>> output = (ArrayList<HashMap<String, Object>>) interpreter.getValue("pos");
        Integer counter = 0;
        ...
        for (HashMap<String, Object> token : output) {
            ...
            if(((Long) token.get("length")).intValue()>1)
            {
                ...
                pos.setPosValue((String)token.get("tag"));
                pos.addToIndexes();
            }
            else
            {
    ...
    public void process(JCas aJCas) throws AnalysisEngineProcessException {
        ...
        for (String text : texts) {
            ...
            try {
                ...
                Map<Integer, Map<Integer, Token>> tokensMap = processPOS(aJCas, beginOffset);
